    ...
    return (
        ...
        <Flex p="20px 10px" justifyContent="space-around" pos="sticky" zIndex="50" top="0px"   gap='2' bg="black" >
           ...
           { navMid && <Box   display="flex" alignItems='baseline' gap="15px">
                ...
                <a  href={resume} download="Krishna_Kevadiya_Resume.pdf" > <Button onClick={()=>toggleClick()} style={{backgroundColor:"gray",fontFamily:"sans-serif",color:"black",border:"1px solid #3AF807"}} >Resume</Button> </a>
            </Box>
            }
            ...
            <MenuList bg="black">
              ...
              <a  href={resume} download="Sujeet_Kumar_Resume.pdf" > <MenuItem onClick={()=>toggleClick()} style={{backgroundColor:"gray",fontFamily:"sans-serif",color:"black"}}> Resume</MenuItem> </a>
            </MenuList>
          </Menu>
            }   
            </Box>
